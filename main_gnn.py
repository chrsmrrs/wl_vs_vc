...
def main():
    ...
    for d, use_labels in dataset:
        ...
        train_acc, train_std, test_acc, test_std,  = gnn_evaluation_no_val(Conv, d, [5], [8], max_num_epochs=2000, batch_size=64,
        ...
        train_acc, train_std, test_acc, test_std,  = gnn_evaluation_no_val(Conv, d, [5], [1024], max_num_epochs=2000, batch_size=64,
                                       start_lr=0.01, factor=99.99, patience=100, num_repetitions=num_reps, all_std=True)
        print(d + " " + "CONV " + str(train_acc) + " " + str(train_std) + " " + str(test_acc) + " " + str(test_std))
        results.append(d + " " + "CONV " + str(train_acc) + " " + str(train_std) + " " + str(test_acc) + " " + str(test_std))
