...
namespace ColorRefinement {
    ...
    public:
        ...
        uint compute_gram_matrix_count(const uint num_iterations, const bool use_labels, const bool use_edge_labels, const bool compute_gram, const bool wloa);
    ...
    private:
        ...
        ColorCounter compute_colors_count(const Graph &g, const uint num_iterations, bool use_labels, bool use_edge_labels);
