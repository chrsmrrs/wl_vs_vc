...
if __name__ == '__main__':
    ...
    parser.add_argument("--file_name", type=str, default='simple_results_4_1024_run_2.csv', help="CSV file to store results")
    parser.add_argument("--seed", type=int, default=1, help="the random seed for torch and numpy")
    ...
    for o in args.order:
        data_list = get_simple_trees(o - 3)
